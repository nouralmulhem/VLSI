...
set fp_units            micro
set fp_top_partition    "TreeMultiplier"         ; # INPUT REQUIRED: Top partition name [Basma]
...
set fp_rows_xl_margin       1.0   ; # Distance from left boundary to start rows    #1.0
...
set pg_stripe_spacing	        2.4u       ; # Spacing between stripes
set pg_stripe_step              2.4u      ; # Step spacing for repeating patterns
set pg_stripe_offset_left       0.32u		; # Offset from left side of chip to start vertical stripe patterns          #0.32
set pg_stripe_offset_right      0.32u		; # Offset from right side of chip to stop vertical stripe patterns
set pg_stripe_offset_top        0.32u		; # Offset from top of chip to stop horizontal stripe patterns
set pg_stripe_offset_bottom     0.32u		; # Offset from bottom of chip to start horizontal stripe patterns
set pg_stripe_start_vmargin     0u		; # Offset from bottom of chip to beginning of vertical stripes
set pg_stripe_stop_vmargin      0u		; # Offset from top of chip to end vertical stripes                       #0.2
set pg_stripe_start_hmargin     0u		; # Offset from left side of chip to start horizontal stripes
set pg_stripe_stop_hmargin      0u		; # Offset from right side of chip to stop horizontal stripes
