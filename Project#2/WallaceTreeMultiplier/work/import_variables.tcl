...
##########################################################################################################################
set MGC_importVerilogNetlist "${workdir}/verilog/demo_TreeMultiplier.syn.v"                     ; # REQUIRED: Path to vg netlist.  Multiple files/wildcards allowed, but must [Basma]
                                                      #           match vg files only. NOT REQUIRED FOR mxdb flow.
set MGC_topDesign            "TreeMultiplier"                ; # REQUIRED  : Name of top level module in verilog netlist(s). [Basma]
