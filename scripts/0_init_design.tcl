...
set parameters 0
set param_values { {WIDTH 32} }
set top_module "SkipAdder_32bits"
set output_dir "${ekit_dir}/${top_module}"

###########################TODO RTL and Constraints paths ######################
set rtl_list { "SkipAdder_32bit.v" "RippleAdder.v" "SkipAdder_4bits.v" "FullAdder.v" "HalfAdder.v" "Mux2_1.v"}
